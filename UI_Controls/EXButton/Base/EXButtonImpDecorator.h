...
#ifndef __TetravexDesigner__EXButtonImpDecorator__
#define __TetravexDesigner__EXButtonImpDecorator__
...
#endif /* defined(__TetravexDesigner__EXButtonImpDecorator__) */
